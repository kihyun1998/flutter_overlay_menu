...
class DemoPresets {
  ...
  static DemoConfiguration get styledItems => DemoConfiguration(
        ...
        itemHoverColor: Colors.blue.withValues(alpha: 0.08),
        itemSplashColor: Colors.blue.withValues(alpha: 0.15),
        itemBorderRadius: 8,
        itemTextSize: 14,
        itemLeadingGap: 12,
        itemTrailingGap: 12,
  ...
  static DemoConfiguration get selectedItem => DemoConfiguration(
        ...
        itemMargin: 2,
        itemBackgroundColor: Colors.transparent,
        itemHoverColor: Colors.grey.withValues(alpha: 0.1),
        itemBorderRadius: 8,
        menuPaddingHorizontal: 8,
        selectedItemBackgroundColor: Colors.blue.withValues(alpha: 0.1),
        selectedItemHoverColor: Colors.blue.withValues(alpha: 0.15),
